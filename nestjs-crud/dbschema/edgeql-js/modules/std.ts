...
const $anyscalar: $anyscalar = $.makeType<$anyscalar>(_.spec, "894d3142-d556-11ec-b893-1194cedc05fb", _.syntax.literal);

type $anyreal = $anyint | $anyfloat | $anynumeric;
const $anyreal: $anyreal = $.makeType<$anyreal>(_.spec, "895252c9-d556-11ec-8174-9d051247dbfb", _.syntax.literal);

type $anyfloat = $number;
const $anyfloat: $anyfloat = $.makeType<$anyfloat>(_.spec, "89559873-d556-11ec-8ed0-67e6592024b1", _.syntax.literal);

type $anyint = $number | $bigint;
const $anyint: $anyint = $.makeType<$anyint>(_.spec, "8952ff10-d556-11ec-9115-0d4ab401dfa8", _.syntax.literal);

type $anynumeric = $decimal | $bigint;
const $anynumeric: $anynumeric = $.makeType<$anynumeric>(_.spec, "89578f8a-d556-11ec-8d9e-fbfed223f5c9", _.syntax.literal);
...
const $sequence: $sequence = $.makeType<$sequence>(_.spec, "895a04e5-d556-11ec-bd7e-9fc97b891df2", _.syntax.literal);
...
const $BaseObject = $.makeType<$BaseObject>(_.spec, "90631bb7-d556-11ec-b4da-9311ba06318f", _.syntax.literal);
...
export type $Object_906a01bad55611ec888b072cfc45e0d2λShape = $.typeutil.flatten<$BaseObjectλShape & {
}>;
type $Object_906a01bad55611ec888b072cfc45e0d2 = $.ObjectType<"std::Object", $Object_906a01bad55611ec888b072cfc45e0d2λShape, null>;
export type $Object = $Object_906a01bad55611ec888b072cfc45e0d2
const $Object_906a01bad55611ec888b072cfc45e0d2 = $.makeType<$Object_906a01bad55611ec888b072cfc45e0d2>(_.spec, "906a01ba-d556-11ec-888b-072cfc45e0d2", _.syntax.literal);

const Object_906a01bad55611ec888b072cfc45e0d2: $.$expr_PathNode<$.TypeSet<$Object_906a01bad55611ec888b072cfc45e0d2, $.Cardinality.Many>, null, true> = _.syntax.$PathNode($.$toSet($Object_906a01bad55611ec888b072cfc45e0d2, $.Cardinality.Many), null, true);
...
const $FreeObject = $.makeType<$FreeObject>(_.spec, "90724fa2-d556-11ec-9514-e7f6471249f9", _.syntax.literal);
...
function min(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::min', args, _.spec, [
    {args: [{typeId: "895252c9-d556-11ec-8174-9d051247dbfb", optional: false, setoftype: true, variadic: false}], returnTypeId: "895252c9-d556-11ec-8174-9d051247dbfb", returnTypemod: "OptionalType", preservesOptionality: true},
    {args: [{typeId: "895ab1b5-d556-11ec-9ec3-8126a8afe6c7", optional: false, setoftype: true, variadic: false}], returnTypeId: "895ab1b5-d556-11ec-9ec3-8126a8afe6c7", returnTypemod: "OptionalType", preservesOptionality: true},
...
function sequence_reset(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::sequence_reset', args, _.spec, [
    {args: [{typeId: "9447bc01-d556-11ec-82be-d90083425a50", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
    {args: [{typeId: "9447bc01-d556-11ec-82be-d90083425a50", optional: false, setoftype: false, variadic: false}, {typeId: "00000000-0000-0000-0000-0000000001ff", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
export { $anyscalar, $anyreal, $anyfloat, $anyint, $anynumeric, bigint, bool, bytes, datetime, decimal, duration, float32, float64, int16, int32, int64, json, $sequence, str, uuid, number, $BaseObject, BaseObject, $Object_906a01bad55611ec888b072cfc45e0d2, Object_906a01bad55611ec888b072cfc45e0d2, $FreeObject, FreeObject };
...
type __defaultExports = {
  ...
  "Object": typeof Object_906a01bad55611ec888b072cfc45e0d2;
...
const __defaultExports: __defaultExports = {
  ...
  "Object": Object_906a01bad55611ec888b072cfc45e0d2,
